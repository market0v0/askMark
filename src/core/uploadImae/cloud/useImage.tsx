...
async function fileUpload (file: any, containerName: string): Promise<any> {
  try {
    ...
    const sasToken = '?sv=2022-11-02&ss=b&srt=sco&sp=rwlaciytfx&se=2024-02-19T13:09:56Z&st=2024-02-19T05:09:56Z&spr=https&sig=4iJEkX0ANggJczVQbnwNA77JJGZ5UF8wFQ8zMLbyFEE%3D'
